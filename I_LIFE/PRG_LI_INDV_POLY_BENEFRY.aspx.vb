...
Partial Class I_LIFE_PRG_LI_INDV_POLY_BENEFRY
...
Proc_Skip_ANB:
        ...
        Try
            ...
            If obj_DT.Rows.Count = 0 Then
                ...
                drNewRow("TBIL_POL_BENF_MDLE") = RTrim("I")
    ...
    Private Function Proc_DoOpenRecord(ByVal FVstrGetType As String, ByVal FVstrRefNum As String, Optional ByVal FVstrRecNo As String = "", Optional ByVal strSearchByWhat As String = "FILE_NUM") As String
        ...
        strSQL = "SPIL_GET_POLICY_BENEFRY"
        ...
        If (objOLEDR.Read()) Then
            ...
            lblOriginator.Text = "Record Originally created by " & GetRecordOriginator(RTrim(CType(objOLEDR("TBIL_POL_BENF_OPERID") & vbNullString, String)))
            Me.lblFileNum.Enabled = False
